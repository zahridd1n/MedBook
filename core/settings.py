...
# PostgreSQL (when DB_NAME is set in .env)
...
# In dev mode run tasks synchronously (no Redis needed)
...
# DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL', default='noreply@booksaas.com')
