...
MARKETING_COPY_DEFAULTS = {
    'uz': {
        ...
        'legal': {
            ...
            'document': 'Huquqiy hujjat',
            'last_updated': 'Oxirgi yangilanish',
            'footer_note': 'Ushbu hujjat O\'zbekiston Respublikasi qonunchiligi asosida tuzilgan.',
        },
        'businesses': {
            'seo_title': 'Bizneslar katalogi — BookFlow',
            'seo_desc': 'Xizmat ko\'rsatuvchi bizneslarning katalogi. Klinika, salon, sartarosh va boshqalar.',
            'eyebrow': 'Bizneslar katalogi',
            'title': 'Xizmatni toping,<br>onlayn band qiling',
            'subtitle': 'Yaqingingizdagi eng yaxshi klinikalar, salonlar, sartaroshxonalar va boshqa bizneslarni toping',
            'search_placeholder': 'Biznes nomi, xizmat turi, shahar...',
            'search_btn': 'Qidirish',
            'all': 'Hammasi',
            ...
            'category': 'Kategoriya',
            'empty_title': 'Hozircha bizneslar yo\'q',
            'empty_subtitle': 'Iltimos, keyinroq qayta urinib ko\'ring yoki boshqa qidiruv so\'zidan foydalaning.',
    ...
    'ru': {
        ...
        'legal': {
            ...
            'footer_note': 'Этот документ составлен в соответствии с законодательством Республики Узбекистан.',
        },
        'businesses': {
            'seo_title': 'Каталог бизнесов — BookFlow',
            'seo_desc': 'Каталог сервисных бизнесов. Клиника, салон, парикмахерская и другие.',
            'eyebrow': 'Каталог бизнесов',
            'title': 'Найдите услугу,<br>запишитесь онлайн',
            'subtitle': 'Найдите лучшие клиники, салоны, парикмахерские и другие бизнесы рядом с вами',
            'search_placeholder': 'Название бизнеса, вид услуги, город...',
            'search_btn': 'Поиск',
            'all': 'Все',
            'working_hours': 'Время работы',
            'open_today': 'Открыто сегодня',
            'city': 'Город',
            'all_cities': 'Все города',
            'category': 'Категория',
            'empty_title': 'Пока нет бизнесов',
            'empty_subtitle': 'Пожалуйста, попробуйте позже или используйте другой поисковый запрос.',
            'badge_premium': 'Премиум',
            'badge_pro': 'Про',
            'badge_new': 'Новый',
            'badge_open': 'Открыто',
            'badge_closed': 'Закрыто',
            'book_btn': 'Записаться',
            'more_btn': 'Подробнее',
        },
        'tutorials': {
    ...
    'en': {
        ...
        'legal': {
            ...
            'footer_note': 'This document is created in accordance with the legislation of the Republic of Uzbekistan.',
        },
        'businesses': {
            'seo_title': 'Businesses Directory — BookFlow',
            'seo_desc': 'Directory of service businesses. Clinics, salons, barbershops, and more.',
            'eyebrow': 'Businesses Directory',
            'title': 'Find a service,<br>book online',
            'subtitle': 'Find the best clinics, salons, barbershops and other businesses near you',
            'search_placeholder': 'Business name, service, city...',
            'search_btn': 'Search',
            'all': 'All',
            ...
            'category': 'Category',
            'empty_title': 'No businesses found',
            'empty_subtitle': 'Please try again later or use a different search query.',
            'badge_premium': 'Premium',
            'badge_pro': 'Pro',
            'badge_new': 'New',
            'badge_open': 'Open',
